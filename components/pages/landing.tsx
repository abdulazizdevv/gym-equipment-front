    ...
    <div className='min-h-screen bg-background'>
        ...
        <div className='container mx-auto flex min-h-14 items-center justify-between gap-2 px-3 sm:min-h-16 sm:gap-3 sm:px-4'>
          ...
          <div className='flex min-w-0 max-w-[calc(100%-8rem)] flex-1 items-center justify-end gap-1.5 sm:max-w-none sm:flex-none sm:gap-3'>
            ...
            <Link
              ...
              className='shrink-0 rounded-lg bg-primary px-2.5 py-2 text-center text-xs font-medium whitespace-nowrap text-primary-foreground transition-opacity hover:opacity-90 sm:px-4 sm:py-2 sm:text-sm'
            >
              {tc('getStarted')}
            </Link>
          </div>
      ...
      <footer className='border-t border-border py-8'>
        <div className='container mx-auto flex flex-col items-center justify-between gap-4 px-4 md:flex-row'>
          ...
          <p className='text-xs text-muted-foreground'>{tc('copyright', {year: new Date().getFullYear()})}</p>
        </div>
      </footer>
    </div>
  );
